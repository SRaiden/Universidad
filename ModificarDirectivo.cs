...
namespace Prueba1
{
    public partial class ModificarDirectivo : Form
    {
        ...
        {
            Clase0001 c = new Clase0001();
            c.ModificarDirectivo(txt1.Text, textBox2.Text, textBox3.Text, textBox20.Text, textBox4.Text, textBox5.Text, textBox6.Text, textBox7.Text, textBox8.Text, textBox10.Text, textBox9.Text, textBox18.Text);
