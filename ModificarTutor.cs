...
namespace Prueba1
{
    public partial class ModificarTutor : Form
    {
        ...
        {
            Clase0001 c = new Clase0001();
            c.ModificarTutor(txt1.Text, textBox2.Text, textBox3.Text, textBox4.Text, textBox5.Text, textBox6.Text, textBox7.Text, textBox8.Text, textBox9.Text, textBox10.Text);
