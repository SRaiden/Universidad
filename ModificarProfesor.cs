...
namespace Prueba1
{
    public partial class ModificarProfesor : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            comando.CommandText = "Select * from Profesores where Legajo = " + textBox1.Text.ToString();
        ...
        {
            Clase0001 c = new Clase0001();
            c.ModificarProfesor(txt1.Text, textBox2.Text, textBox3.Text, textBox4.Text, textBox5.Text, textBox6.Text, textBox7.Text, textBox8.Text, textBox9.Text, textBox10.Text);
